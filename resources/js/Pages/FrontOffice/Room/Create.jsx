                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div>
                                            <Input
                                                id="number"
                                                value={data.number}
                                                placeholder="e.g., 101, 202, Presidential Suite"
                                                onChange={(e) => {
                                                    setData(
                                                        "number",
                                                        e.target.value,
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        >
                                            <SelectTrigger className="border-amber-300 focus:ring-amber-500">
                                                <SelectValue placeholder="Choose a type room" />
                                            </SelectTrigger>
                                            <SelectContent>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="space-y-2">
                                            {data.features.map(
                                                (feature, index) => (
                                                    ...
                                                    >
                                                        <Input
                                                            placeholder="e.g., King Size Bed, Ocean View, Mini Bar"
                                                            value={feature}
                                                            onChange={(e) =>
                                                                handleFeatureChange(
                                                                    index,
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Add all amenities and features
